...
<body className={`${inter.className} antialiased`}>
  <div style={{ position: "absolute", zIndex: 99999 }}>
    <input autoComplete="off" type="checkbox" id="aadsstickyme7zy2vu" hidden />
    <div style={{ paddingTop: 0, paddingBottom: "auto" }}>
      ...
      >
        ...
        >
          <iframe
            data-aa="2406432"
            src="//acceptable.a-ads.com/2406432/?size=Adaptive"
            style={{
              border: 0,
              padding: 0,
              width: "70%",
      ...
      <style>{`
        #aadsstickyme7zy2vu:checked + div {
          display: none;
        }
      `}</style>
    </div>
